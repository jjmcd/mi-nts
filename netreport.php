...
<?php
    ...
    echo "<p><h1>Net reports for " . convertDate(singleResult($SQL,$db)) .
	"</h1></p>\n";
    ...
    echo "<table>\n";
    echo "<tr><th align=\"left\">Net Name</th><th>QNI</th><th>QTC" .
    ...
    while ( $myrow = getRow($result,$db) )
	{
	    ...
	    echo '    <td ' . $id . ' align="left"><a href="netdata.php?netid='
	      . $myrow[7] . '">' . $myrow[0] . "</a></td>\n";
